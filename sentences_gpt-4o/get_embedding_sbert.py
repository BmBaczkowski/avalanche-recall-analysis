...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Get text embeddings using SBERT.")
    parser.add_argument('filelist', type=str, help="Path to the file containing the sentences generated by gpt")
    parser.add_argument('llm_path', type=str, help="Path to the directory containing the LLM")
    parser.add_argument('module_path', type=str, help="Path to the directory containing the utility module")
    parser.add_argument('outlist', type=str, help="Path to the list with output files")
...
def main():
    ...
    Embedder = import_utilities(args.module_path)
